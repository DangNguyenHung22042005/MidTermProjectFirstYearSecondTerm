...
public class Captcha2 extends JFrame implements ActionListener, MouseListener {
	...
	JToggleButton tglbtnImg_9;
	String nameOfBoss;

	public Captcha2(String nameOfBoss) {
		...
		JLabel label_tieuDe = new JLabel("Vui lòng chọn tất cả ảnh xuất hiện \"con mèo\"");
		...
		URL src1 = TrangDangNhap.class.getResource("/image/cat_images_3.jpg");
		Image temp1 = Toolkit.getDefaultToolkit().createImage(src1);
		ImageIcon cat_3 = new ImageIcon(temp1.getScaledInstance(150, 102, temp1.SCALE_SMOOTH));
		
		URL src2 = TrangDangNhap.class.getResource("/image/bird_images_1.jpg");
		Image temp2 = Toolkit.getDefaultToolkit().createImage(src2);
		ImageIcon bird_1 = new ImageIcon(temp2.getScaledInstance(150, 102, temp2.SCALE_SMOOTH));
		
		URL src3 = TrangDangNhap.class.getResource("/image/cat_images_2.jpg");
		Image temp3 = Toolkit.getDefaultToolkit().createImage(src3);
		ImageIcon cat_2 = new ImageIcon(temp3.getScaledInstance(150, 102, temp3.SCALE_SMOOTH));
		
		URL src4 = TrangDangNhap.class.getResource("/image/fish_images_1.jpg");
		Image temp4 = Toolkit.getDefaultToolkit().createImage(src4);
		ImageIcon fish_1 = new ImageIcon(temp4.getScaledInstance(150, 102, temp4.SCALE_SMOOTH));
		
		URL src5 = TrangDangNhap.class.getResource("/image/elephant_images_1.jpg");
		Image temp5 = Toolkit.getDefaultToolkit().createImage(src5);
		ImageIcon elephant_1 = new ImageIcon(temp5.getScaledInstance(150, 102, temp5.SCALE_SMOOTH));
		
		URL src6 = TrangDangNhap.class.getResource("/image/dog_images_3.jpg");
		Image temp6 = Toolkit.getDefaultToolkit().createImage(src6);
		ImageIcon dog_3 = new ImageIcon(temp6.getScaledInstance(150, 102, temp6.SCALE_SMOOTH));
		
		URL src7 = TrangDangNhap.class.getResource("/image/crocodile_images_1.jpg");
		Image temp7 = Toolkit.getDefaultToolkit().createImage(src7);
		ImageIcon crocodile_1 = new ImageIcon(temp7.getScaledInstance(150, 102, temp7.SCALE_SMOOTH));
		
		URL src8 = TrangDangNhap.class.getResource("/image/cat_images_1.jpg");
		Image temp8 = Toolkit.getDefaultToolkit().createImage(src8);
		ImageIcon cat_1 = new ImageIcon(temp8.getScaledInstance(150, 102, temp8.SCALE_SMOOTH));
		
			URL src9 = TrangDangNhap.class.getResource("/image/dog_images_2.jpg");
		Image temp9 = Toolkit.getDefaultToolkit().createImage(src9);
		ImageIcon dog_2 = new ImageIcon(temp9.getScaledInstance(150, 102, temp9.SCALE_SMOOTH));
		
		tglbtnImg_1 = new JToggleButton(cat_3);
		tglbtnImg_1.setFont(new Font("Tahoma", Font.PLAIN, 5));
		tglbtnImg_1.setBounds(10, 112, 133, 102);
		tglbtnImg_1.addActionListener(this);
		getContentPane().add(tglbtnImg_1);
		
		tglbtnImg_2 = new JToggleButton(bird_1);
		tglbtnImg_2.setFont(new Font("Tahoma", Font.PLAIN, 5));
		tglbtnImg_2.setBounds(176, 112, 133, 102);
		tglbtnImg_2.addActionListener(this);
		getContentPane().add(tglbtnImg_2);		
		
		tglbtnImg_3 = new JToggleButton(cat_2);
		tglbtnImg_3.setBounds(343, 112, 133, 102);
		tglbtnImg_3.addActionListener(this);
		getContentPane().add(tglbtnImg_3);				
	
		tglbtnImg_4 = new JToggleButton(fish_1);
		tglbtnImg_4.setBounds(10, 244, 133, 102);
		tglbtnImg_4.addActionListener(this);
		getContentPane().add(tglbtnImg_4);			

		tglbtnImg_5 = new JToggleButton(elephant_1);
		tglbtnImg_5.setBounds(176, 244, 133, 102);
		tglbtnImg_5.addActionListener(this);
		getContentPane().add(tglbtnImg_5);			
		
		tglbtnImg_6 = new JToggleButton(dog_3);
		tglbtnImg_6.setBounds(343, 244, 133, 102);
		tglbtnImg_6.addActionListener(this);
		getContentPane().add(tglbtnImg_6);		
		
		tglbtnImg_7 = new JToggleButton(crocodile_1);
		tglbtnImg_7.setBounds(10, 368, 133, 102);
		tglbtnImg_7.addActionListener(this);
		getContentPane().add(tglbtnImg_7);
		
		tglbtnImg_8 = new JToggleButton(cat_1);
		tglbtnImg_8.setBounds(176, 368, 133, 102);
		tglbtnImg_8.addActionListener(this);
		getContentPane().add(tglbtnImg_8);		
			
		tglbtnImg_9 = new JToggleButton(dog_2);
		tglbtnImg_9.setBounds(343, 368, 133, 102);
		tglbtnImg_9.addActionListener(this);
		getContentPane().add(tglbtnImg_9);
	...
	public void mouseClicked(MouseEvent e) {
		if (!(tglbtnImg_1.isSelected() || tglbtnImg_2.isSelected() || tglbtnImg_3.isSelected() || tglbtnImg_4.isSelected()
				|| tglbtnImg_5.isSelected() || tglbtnImg_6.isSelected() || tglbtnImg_7.isSelected()
				|| tglbtnImg_8.isSelected() || tglbtnImg_9.isSelected())) {
			JOptionPane.showMessageDialog(this, "Vui lòng chọn các hình ảnh phù hợp!", "ERROR",
					JOptionPane.ERROR_MESSAGE);
		} else if ((tglbtnImg_1.isSelected() && tglbtnImg_3.isSelected() && tglbtnImg_8.isSelected())
				&& !(tglbtnImg_2.isSelected() || tglbtnImg_4.isSelected() || tglbtnImg_5.isSelected()
						|| tglbtnImg_6.isSelected() || tglbtnImg_6.isSelected() || tglbtnImg_9.isSelected())) {
