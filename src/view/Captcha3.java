...
public class Captcha3 extends JFrame implements ActionListener, MouseListener {
	...
	public Captcha3(String nameOfBoss) {
		...
		JLabel label_tieuDe = new JLabel("Vui lòng chọn tất cả ảnh xuất hiện \"xe đạp\"");
		...
		URL src1 = TrangDangNhap.class.getResource("/image/fish_images_1.jpg");
		Image temp1 = Toolkit.getDefaultToolkit().createImage(src1);
		ImageIcon fish_1 = new ImageIcon(temp1.getScaledInstance(150, 102, temp1.SCALE_SMOOTH));
			
		URL src2 = TrangDangNhap.class.getResource("/image/xedap_images_1.jpg");
		Image temp2 = Toolkit.getDefaultToolkit().createImage(src2);
		ImageIcon xedap_1 = new ImageIcon(temp2.getScaledInstance(150, 102, temp2.SCALE_SMOOTH));
		
		URL src3 = TrangDangNhap.class.getResource("/image/dog_images_1.jpg");
		Image temp3 = Toolkit.getDefaultToolkit().createImage(src3);
		ImageIcon dog_1 = new ImageIcon(temp3.getScaledInstance(150, 102, temp3.SCALE_SMOOTH));	
		...
		URL src5 = TrangDangNhap.class.getResource("/image/xedap_images_2.jpg");
		Image temp5 = Toolkit.getDefaultToolkit().createImage(src5);
		ImageIcon xedap_2 = new ImageIcon(temp5.getScaledInstance(150, 102, temp5.SCALE_SMOOTH));
		...
		URL src7 = TrangDangNhap.class.getResource("/image/dog_images_2.jpg");
		Image temp7 = Toolkit.getDefaultToolkit().createImage(src7);
		ImageIcon dog_2 = new ImageIcon(temp7.getScaledInstance(150, 102, temp7.SCALE_SMOOTH));
		
		URL src8 = TrangDangNhap.class.getResource("/image/xedap_images_3.jpg");
		Image temp8 = Toolkit.getDefaultToolkit().createImage(src8);
		ImageIcon xedap_3 = new ImageIcon(temp8.getScaledInstance(150, 102, temp8.SCALE_SMOOTH));
		
		URL src9 = TrangDangNhap.class.getResource("/image/crocodile_images_1.jpg");
		Image temp9 = Toolkit.getDefaultToolkit().createImage(src9);
		ImageIcon crocodile_1 = new ImageIcon(temp9.getScaledInstance(150, 102, temp9.SCALE_SMOOTH));
		
		tglbtnImg_1 = new JToggleButton(fish_1);
		...
		tglbtnImg_2 = new JToggleButton(xedap_1);
	...
	public void mouseClicked(MouseEvent e) {
		...
		} else if ((tglbtnImg_2.isSelected() && tglbtnImg_5.isSelected() && tglbtnImg_8.isSelected())
				&& !(tglbtnImg_1.isSelected() || tglbtnImg_3.isSelected() || tglbtnImg_4.isSelected()
						|| tglbtnImg_6.isSelected() || tglbtnImg_7.isSelected() || tglbtnImg_9.isSelected())) {
